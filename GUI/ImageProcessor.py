...
def image_whitener(file):
    ...
    new_file_path = file.split(splitval)
    new_file = new_file_path[-1].split(".")
    s = splitval
    new_file_path = s.join(new_file_path[:-1])
    new_file_path = new_file_path + splitval +str(new_file[0]) + "_whitened.jpg"
    print(new_file_path)
...
if __name__ == "__main__":
    ...
    numpy.save("NonLetterData/nonletter_data_array.npy", nonletters)
